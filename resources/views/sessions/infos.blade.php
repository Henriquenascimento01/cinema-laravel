    ...
    <div class="col-md-10 offset-md-1">
        <div class="row">
            <div id="image-container" class="col-md-6">
                <img src="/img/movies/{{ $sessions->movie->image }}" alt="" class="img-fluid">
                <div id="info-container" class="col-md-6">
                    ...
                    <p class="session-tag">Gênero: {{ $sessions->movie->tag->name }}</p>
                    <p class="session-classification">Classificação: {{ $sessions->movie->classification->name }}</p>
                </div>
